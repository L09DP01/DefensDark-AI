...
const HAS_AUTHENTICATED_BEFORE_STORAGE_KEY = "defensdark-ai_has_authed_before";
 ...
 *   2. Underlying-model ids from before the DefensDark AI tier rebrand
 *      (e.g. `"opus-4.6"` → `"defensdark-ai-max"`) — handled by `coerceSelectedModel`.
