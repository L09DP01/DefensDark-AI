        ...
        <div className="w-full min-w-0 flex flex-row gap-x-8 gap-y-3 justify-between items-center">
          <div className="w-full min-w-0 flex flex-row gap-4 items-center">
            <div className="flex flex-col gap-1.5 min-w-0">
              <p className="text-sm">
                Turn on extra usage to keep using DefensDark AI if you hit a
                limit.{" "}
                <a
                  href="https://help.defensdark-ai.co/en/articles/13455916-extra-usage-for-paid-defensdark-ai-plans"
                  target="_blank"
