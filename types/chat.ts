 ...
 * shapes:
 *   1. Underlying-model ids from before the DefensDark AI tier rebrand.
 *   2. `defensdark-ai-lite` from the short-lived first naming of the entry tier
 *      (renamed to `defensdark-ai-standard` because Lite mis-described Kimi K2.6).
 * Used by `coerceSelectedModel` to migrate values on read.
 */
export const LEGACY_MODEL_ID_MAP: Record<string, SelectedModel> = {
  "sonnet-4.6": "defensdark-ai-pro",
  "opus-4.6": "defensdark-ai-max",
  "gemini-3-flash": "defensdark-ai-standard",
  "kimi-k2.6": "defensdark-ai-standard",
  ...
  "grok-4.1": "defensdark-ai-standard",
  "grok-4.3": "defensdark-ai-standard",
  "defensdark-ai-lite": "defensdark-ai-standard",
};
